...
finder.prototype={
    draw:function () {
        this.cobj.save();
        this.cobj.translate(this.x,this.y);
        this.cobj.drawImage(this.finder[this.state],0,0,92,90,0,0,this.width,this.height);
        this.cobj.restore();
    }
}
...
zidan.prototype = {
    draw:function () {
        ...
        this.cobj.save();
        this.cobj.translate(this.x,this.y);
        this.cobj.drawImage(this.zhi[this.state],0,0,216,119,0,0,this.width,this.height);
        this.cobj.restore();
    }
}
